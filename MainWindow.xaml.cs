...
_http =
    ...
    private void CreditLink_Click(
        object sender,
        RoutedEventArgs e
    )
    {
        var surfaceBrush =
            TryFindResource("SurfaceBrush") as Brush ??
            Brushes.White;

        var inkBrush =
            TryFindResource("InkBrush") as Brush ??
            Brushes.Black;

        var mutedBrush =
            TryFindResource("MutedBrush") as Brush ??
            Brushes.Gray;
        ...
        var lineBrush =
            TryFindResource("LineBrush") as Brush ??
            Brushes.LightGray;
